...
public class Task {
    ...
    transient private TypeTask type;
    private long duration;
    transient private final LocalDateTime DEFAULT_DATE = LocalDateTime.of(9999,1,1,0,0);
    private LocalDateTime startTime = DEFAULT_DATE;
    transient private final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
    ...
    public Task(int id, TypeTask type, String title, String description, StatusTask status, long duration, LocalDateTime startTime) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.status = status;
    ...
    public void substitutionOfOldValuesOnUpdate(Task oldTask) {
        ...
        if (this.getStartTime() == null || this.getStartTime() == DEFAULT_DATE) {
